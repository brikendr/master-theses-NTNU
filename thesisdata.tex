\thesistitle{Disambiguation of Named Entities using a novel gamified framework}
\thesisauthor{Brikend Rama}
\thesissupervisor{Mariusz Nowostawski}

\gmtkeywords{Disambiguation of Named Entities using a novel gamified framework}
...
\gmtcontact{Brikend Rama\aa s, brikendr@stud.ntnu.no, 131713}
